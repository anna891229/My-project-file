...
public class R_Dist_SpecificPage extends AppCompatActivity {
    Button Tohome,ToRhome,Dist1,Dist2,Dist3,Dist4,Dist5,Dist6,Dist7,Dist8,Dist9,Dist10,Dist11,Dist12;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rdist_specific_page);

        Tohome = findViewById(R.id.Home3);  // 回首頁
        Tohome.setOnClickListener(v -> {
            Intent intent = new Intent();
            intent.setClass(R_Dist_SpecificPage.this, Homepage.class);
            startActivity(intent);
        });
        ToRhome = findViewById(R.id.ReNormal3);  // 回首頁
        ToRhome.setOnClickListener(v -> {
            Intent intent = new Intent();
            intent.setClass(R_Dist_SpecificPage.this, R_Homepage.class);
            startActivity(intent);
        });
        ...
        Dist1.setOnClickListener(v -> {
            ...
            intent.setClass(R_Dist_SpecificPage.this, R_Dist_SpecificPage2.class);
            startActivity(intent);
        });
