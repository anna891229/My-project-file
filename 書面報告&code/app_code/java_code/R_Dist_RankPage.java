...
public class R_Dist_RankPage extends AppCompatActivity {
    ...
    String chooseyear,housetype;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rdist_rank_page);
        ...
        type = findViewById(R.id.type);  //設定 房屋種類的下拉式選單
        ...
        tohome.setOnClickListener(v -> {
            ...
            intent.setClass(R_Dist_RankPage.this, Homepage.class);
            startActivity(intent);
        });

        toREhome = findViewById(R.id.button7);   // 跳回RE首頁
        toREhome.setOnClickListener(v -> {
            Intent intent = new Intent();
            intent.setClass(R_Dist_RankPage.this, R_Homepage.class);
            startActivity(intent);
        });
    }
    private Runnable mutiThread = new Runnable() {
        ...
        public void run() {
            ...
            try {
                URL url = new URL("https://8e3d-163-14-44-237.jp.ngrok.io/forecast/rent_rank.php?"+"year="+chooseyear+"&housetype="+housetype);
