...
public class Age_rank extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_age_rank);
        ...
        tohome.setOnClickListener(v -> {
            ...
            intent.setClass(Age_rank.this, Homepage.class);
            startActivity(intent);
        });

        toREhome = findViewById(R.id.button7);   // 跳回Age首頁
        toREhome.setOnClickListener(v -> {
            Intent intent = new Intent();
            intent.setClass(Age_rank.this, Agepage.class);
            startActivity(intent);
        });
    }
    private Runnable mutiThread = new Runnable() {
        ...
        public void run() {
            ...
            try {
                URL url = new URL("https://8e3d-163-14-44-237.jp.ngrok.io/forecast/age_rank.php?"+"year="+chooseyear);
