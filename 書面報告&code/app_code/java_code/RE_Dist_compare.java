...
public class RE_Dist_compare extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_re_dist_compare);
        ...
        tohome.setOnClickListener(v -> {
            ...
            intent.setClass(RE_Dist_compare.this, Homepage.class);
            startActivity(intent);
        });

        toREhome = findViewById(R.id.button4);   // 跳回RE首頁
        toREhome.setOnClickListener(v -> {
            Intent intent = new Intent();
            intent.setClass(RE_Dist_compare.this, RE_Homepage.class);
            startActivity(intent);
        });
    }
    private Runnable mutiThread = new Runnable() {
        ...
        public void run() {
            ...
            try {
                URL url = new URL("https://8e3d-163-14-44-237.jp.ngrok.io/forecast/dist_compare.php?"+"dist1="+dist1+"&dist2="+dist2+"&dist3="+dist3+"&type="+housetype);
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    int baryear = 102;
                    for (int i = 1; i < 21; i+=2) {//建立BarChart的數值
                    ...
                    int baryear2 = 102;
                    for (int i = 23; i < 43; i+=2) {//建立BarChart的數值
                    ...
                    int baryear3= 102;
                    for (int i = 45; i < 65; i+=2) {//建立BarChart的數值
