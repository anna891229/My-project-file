...
public class RE_rank extends AppCompatActivity {
    ...
    String chooseyear,dbtype,housetype;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_re_rank);
        ...
        tohome.setOnClickListener(v -> {
            ...
            intent.setClass(RE_rank.this, Homepage.class);
        ...
        toREhome.setOnClickListener(v -> {
            Intent intent = new Intent();
            intent.setClass(RE_rank.this, RE_Homepage.class);
            startActivity(intent);
        });
    }
    private Runnable mutiThread = new Runnable() {
        ...
        public void run() {
            ...
            try {
                URL url = new URL("https://8e3d-163-14-44-237.jp.ngrok.io/forecast/dist_rank.php?"+"year="+chooseyear+"&type="+dbtype+"&housetype="+housetype);
