...
<body>
                ...
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="sweet4.php" class="nav-item nav-link active">布朗尼</a>
				...
				<div id="header-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active" style="height: 410px;">
                            <img class="img-fluid" src="img/sweet4-0.jpg" alt="Image">
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
                              
                                    <h3 class="display-4 text-white font-weight-semi-bold mb-4">布朗尼</h3>
									<h4 class="text-light text-uppercase font-weight-medium mb-3">選用來自法國頂級的巧克力</h4>
                         
                                </div>
                            </div>
                        </div>
                        <div class="carousel-item" style="height: 410px;">
                            <img class="img-fluid" src="img/sweet4-0-1.jpg" alt="Image">
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
                                    <h4 class="display-5 text-white font-weight-semi-bold mb-4">焦糖與可可烘烤後</h4>
                                    <h4 class="display-5 text-white font-weight-semi-bold mb-4">在布朗尼表層形成薄脆外衣</h4>
									<h4 class="display-5 text-white font-weight-semi-bold mb-4">使布朗尼更添加口感與濃郁甜味香氣</h4>
    ...
    <div class="container-fluid bg-secondary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 300px">
            <h1 class="font-weight-semi-bold text-uppercase mb-3">布朗尼</h1>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-16 pb-1">
                        <div class="card product-item border-0 mb-4">
                            <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                                <img class="img-fluid w-100" src="img/sweet4-1.JPG" alt="">
                            </div>
                            <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                                <h6 class="text-truncate mb-3">經典布朗尼</h6>
                                <div class="d-flex justify-content-center">
                                    <h6>NT$120.00</h6>
                                </div>
                            </div>
                            <a href = "c_buy.php?id=10">
