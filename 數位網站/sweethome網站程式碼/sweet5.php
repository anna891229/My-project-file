...
<body>
                ...
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="sweet5.php" class="nav-item nav-link active">瑪德蓮</a>
				...
				<div id="header-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active" style="height: 410px;">
                            <img class="img-fluid" src="img/sweet5-0.JPG" alt="Image">
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
                              
                                    <h3 class="display-4 text-white font-weight-semi-bold mb-4">瑪德蓮</h3>
									<h4 class="text-light text-uppercase font-weight-medium mb-3">法國最具代表性的甜點</h4>
                         
                                </div>
                            </div>
                        </div>
                        <div class="carousel-item" style="height: 410px;">
                            <img class="img-fluid" src="img/sweet5-0-1.JPG" alt="Image">
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
                                    <h4 class="display-4 text-white font-weight-semi-bold mb-4">簡單經典的貝殼造型</h4>
                                    <h4 class="display-4 text-white font-weight-semi-bold mb-4">雞蛋、麵粉、糖和 黃油四種原料製成</h4>

                                </div>
                            </div>
                        </div>
						<div class="carousel-item" style="height: 410px;">
                            <img class="img-fluid" src="img/sweet5-1.JPG" alt="Image">
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
									<h3 class="display-4 text-white font-weight-semi-bold mb-4">讓人難以忘懷甜蜜香氣</h3>
                                    <h4 class="text-light text-uppercase font-weight-medium mb-3">成為家喻戶曉知名甜點</h4>
    ...
    <div class="container-fluid bg-secondary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 300px">
            <h1 class="font-weight-semi-bold text-uppercase mb-3">瑪德蓮</h1>
            ...
            <div class="col-lg-9 col-md-12">
                <div class="row pb-3">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-16 pb-1">
                        <div class="card product-item border-0 mb-4">
                            <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                                <img class="img-fluid w-100" src="img/sweet5-1.JPG" alt="">
                            </div>
                            <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                                <h6 class="text-truncate mb-3">原味瑪德蓮</h6>
                                <div class="d-flex justify-content-center">
                                    <h6>NT$50.00</h6>
                                </div>
                            </div>
                            <a href = "c_buy.php?id=12">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-16 pb-1">
                        <div class="card product-item border-0 mb-4">
                            <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                                <img class="img-fluid w-100" src="img/sweet5-3.JPG" alt="">
                            </div>
                            <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                                <h6 class="text-truncate mb-3">草莓瑪德蓮</h6>
                                <div class="d-flex justify-content-center">
                                    <h6>NT$55.00</h6>
                                </div>
                            </div>
                            <a href = "c_buy.php?id=14">
                                <button><i class="fas fa-shopping-cart text-primary mr-1"></i>加入購物車</button>
							</a>
                        </div>
                    </div>
					<div class="col-lg-4 col-md-6 col-sm-16 pb-1">
                        <div class="card product-item border-0 mb-4">
                            <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                                <img class="img-fluid w-100" src="img/sweet5-4.JPG" alt="">
                            </div>
                            <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                                <h6 class="text-truncate mb-3">抹茶瑪德蓮</h6>
                                <div class="d-flex justify-content-center">
                                    <h6>NT$55.00</h6>
                                </div>
                            </div>
                            <a href = "c_buy.php?id=15">
                                <button><i class="fas fa-shopping-cart text-primary mr-1"></i>加入購物車</button>
							</a>
                        </div>
                    </div>
