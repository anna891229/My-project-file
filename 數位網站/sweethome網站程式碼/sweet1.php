...
<body>
        ...
        <div class="row bg-secondary py-2 px-xl-5">
            <div class="col-lg-6 d-none d-lg-block">
                <div class="d-inline-flex align-items-center">
                    <a class="text-dark" href="question.html">Q & A</a>
                ...
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="sweet1.php" class="nav-item nav-link active">提拉米蘇</a>
				...
				<div id="header-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active" style="height: 410px;">
                            <img class="img-fluid" src="img/sweet1-1.JPG" alt="Image">
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
                              
                                    <h3 class="display-4 text-white font-weight-semi-bold mb-4">提拉米蘇</h3>
									<h4 class="text-light text-uppercase font-weight-medium mb-3">著名的義大利式甜點</h4>
                         
                                </div>
                            </div>
                        </div>
                        <div class="carousel-item" style="height: 410px;">
                            <img class="img-fluid" src="img/sweet1-2.JPG" alt="Image">
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
                                    <h4 class="display-4 text-white font-weight-semi-bold mb-4">泡過咖啡或蘭姆酒的手指餅乾</h4>
                                    <h4 class="display-4 text-white font-weight-semi-bold mb-4">加上一層馬斯卡彭起司</h4>

                                </div>
                            </div>
                        </div>
						<div class="carousel-item" style="height: 410px;">
                            <img class="img-fluid" src="img/sweet1-3.JPG" alt="Image">
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
									<h3 class="display-4 text-white font-weight-semi-bold mb-4">口感細膩飽滿</h3>
                                    <h4 class="text-light text-uppercase font-weight-medium mb-3">譽為「大人系」甜點的代表之一</h4>
    ...
    <div class="container-fluid bg-secondary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 300px">
            <h1 class="font-weight-semi-bold text-uppercase mb-3">提拉米蘇</h1>
                ...
                <div class="row pb-3">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 pb-1">
                        <div class="card product-item border-0 mb-4">
                            <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                                <img class="img-fluid w-100" src="img/sweet1-3.JPG" alt="">
                            </div>
                            <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                                <h6 class="text-truncate mb-3">堤拉米蘇</h6>
                                <div class="d-flex justify-content-center">
                                    <span>NT$250.00</span>
                                </div>
                            </div>
                            <div class="card-footer d-flex justify-content-between bg-light border">
                            <a href = "c_buy.php?id=1">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 pb-1">
                        <div class="card product-item border-0 mb-4">
                            ...
                            <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                                <h6 class="text-truncate mb-3">堤拉米蘇(未含酒精)</h6>
                                <div class="d-flex justify-content-center">
                                    <span>NT$250.00</span>
                                </div>
                            </div>
                            <div class="card-footer d-flex justify-content-between bg-light border">
                            <a href = "c_buy.php?id=2">
                                <button><i class="fas fa-shopping-cart text-primary mr-1"></i>加入購物車</button>
							</a>	
                            </div>
                        </div>
