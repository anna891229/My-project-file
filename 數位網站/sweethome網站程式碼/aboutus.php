...
<body>
                ...
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="aboutus.php" class="nav-item nav-link active">關於我們</a>
				...
				<div id="header-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active" style="height: 410px;">
                            ...
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
                                    <h3 class="display-4 text-white font-weight-semi-bold mb-4">品牌理念</h3>
                                    <h4 class="text-light text-uppercase font-weight-medium mb-3">Sweety</h4>
                        ...
                        <div class="carousel-item" style="height: 410px;">
                            ...
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
                                    <h3 class="display-4 text-white font-weight-semi-bold mb-4">拉近人與人之間綿密情感</h3>
                                    <h4 class="text-light text-uppercase font-weight-medium mb-3">以溫柔細膩的方式</h4>
                                    <h4 class="text-light text-uppercase font-weight-medium mb-3">為生活注入一點甜蜜感</h4>
                                </div>
                            </div>
                        </div>
						<div class="carousel-item" style="height: 410px;">
                            <img class="img-fluid" src="img/home3.jpg" alt="Image">
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
                                    <h3 class="display-4 text-white font-weight-semi-bold mb-4">用最純粹的食材</h3>
									<h3 class="display-4 text-white font-weight-semi-bold mb-4">成就最滿足的味</h3>
    ...
    <div class="container-fluid bg-secondary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 300px">
            <h1 class="font-weight-semi-bold text-uppercase mb-3">關於我們</h1>
    ...
    <div class="container-fluid pt-5">
        ...
        <div class="row px-xl-5">
            ...
            <div class="col-lg-5 mb-5">
				<h3 class="font-weight-semi-bold mb-3">品牌理念</h3>
                <p>以溫柔細膩的方式，為生活注入一點甜蜜感。</p>
				<p>拉近人與人之間的綿密情感，打造每個獨特、驚喜的日常。</p>
				<p>您知道嗎？</p>
				<p>您的這一口，是甜點師的一輩子</p>
				<p>您嚐到的這不是法國的瑪德蓮，也不是美國的布朗尼</p>
				<p>用最純粹的食材，成就最滿足的味</p>
				<p>這是“Sweety販賣部”</p>
			...
			<div class="col-lg-5 mb-5">
				<div class="d-flex flex-column mb-3">
                    <h4 class="font-weight-semi-bold mb-3">實體門市 1 </h4>
                    ...
                    <p class="mb-2"><i class="fa fa-phone-alt text-primary mr-3"></i>(02)52152120</p>
                </div>
				<div class="d-flex flex-column mb-3">
                    <h4 class="font-weight-semi-bold mb-3">實體門市 2</h4>
                    <p class="mb-2"><i class="fa fa-map-marker-alt text-primary mr-3"></i>台北市士林區臨溪路70號</p>
                    <p class="mb-2"><i class="fa fa-envelope text-primary mr-3"></i>sweetyhome2@gmail.com</p>
                    <p class="mb-0"><i class="fa fa-phone-alt text-primary mr-3"></i>(02)52152122</p>
                </div>
				<div class="d-flex flex-column">
			
					<h4 class="font-weight-semi-bold mb-3">媒體報導/獎項</h4>
					<p>榮獲 國際美食金食獎冠軍!! </p>
				</div>
        ...
        <div class="row px-xl-5 pt-5">
            <div class="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
                <a href="" class="text-decoration-none">
                    <h1 class="mb-4 display-5 font-weight-semi-bold"><span class="text-primary font-weight-bold border border-white px-3 mr-1">Sweet</span>Store</h1>
                </a>
