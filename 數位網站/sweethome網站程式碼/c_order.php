<?php
	...
	$sql = "SELECT * FROM `c_order` WHERE `userid`= '$_COOKIE[id]' ORDER BY `c_order`.`date` DESC,`c_order`.`time` DESC";
...
<body>
                ...
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="c_member.php" class="nav-item nav-link">會員專區</a>
                            <a href="c_order.php" class="nav-item nav-link active">訂單紀錄</a>
                        </div>
    ...
    <div class="container-fluid bg-secondary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 300px">
            <h1 class="font-weight-semi-bold text-uppercase mb-3">訂單紀錄</h1>
				...
				<thead class="bg-secondary text-dark">
					...
					<form action="a_del_news.php" method="post">
                        <tr >
							...
							<td class="align-middle" ><?= $row['if_pay']; ?></td>							
                        </tr>
					<?php } ?>   
					</form>
