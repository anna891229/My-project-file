<?php
	...
	$sql = "SELECT * FROM `item` ORDER BY `item`.`amounts` ASC ";
...
<head>
    <meta charset="utf-8">
    <title>Sweety Administrator item</title>
...
<body>
                ...
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
							...
							<a href="a_item.php" class="nav-item nav-link active">商品庫存管理</a>  
                        </div>
    ...
    <div class="container-fluid bg-secondary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 300px">
            <h1 class="font-weight-semi-bold text-uppercase mb-3">商品庫存管理管理</h1>
            <div class="d-inline-flex">
                <p class="m-0"><a href="admin.php">管理首頁</a></p>
                <p class="m-0 px-2">-</p>
                <p class="m-0">商品庫存管理</p>
            </div>
        </div>
    </div>
    <!-- Page Header End -->
	<table class="table table-bordered text-center mb-0">
				<thead class="bg-secondary text-dark">
					...
					<form action="a_del_news.php" method="post">
                        <tr >
                            <td class="align-middle" ><?= $row['itemid']; ?></td>
                            <td class="align-middle" ><?= $row['name']; ?></td>
                            <td class="align-middle" ><?= $row['price']; ?></td>	
                            <td class="align-middle" ><?= $row['amounts']; ?></td>							
                        </tr>
					<?php } ?>   
					</form>
	...
	<div class="col-lg-5 mb-5">
		<form action="a_update_items.php" method="post" align="center">
		<h4>
			<p>  </p>
			<td align = "right">~~修改商品數量~~</td>
			<p>  </p>
			<p>商品id : </p>
			<p><textarea name="title0" rows="2" cols="50"></textarea></p>
			<p>修改之商品數量 : </p>
			<p><textarea name="title" rows="2" cols="50"></textarea></p>
	...
	<div class="col-lg-5 mb-5">
		<form action="a_update_itemprice.php" method="post" align="center">
		<h4>
			<p>  </p>
			<td align = "right">~~修改商品價格~~</td>
			<p>  </p>
			<p>商品id : </p>
			<p><textarea name="title0" rows="2" cols="50"></textarea></p>
			<p>修改之商品價格 : </p>
