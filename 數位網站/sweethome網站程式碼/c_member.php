    ...
    <div class="container-fluid mb-5">
        <div class="row border-top px-xl-5">
            ...
            <div class="col-lg-9">
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="c_member.php" class="nav-item nav-link active">會員專區</a>
                            <a href="c_order.php" class="nav-item nav-link">訂單紀錄</a>
                        </div>
                ...
                <h3 class="font-weight-semi-bold mb-3">會員資料修改</h3>
                <form action="member_update.php" class="signin-form" method = "POST">
					<div class="form-group mb-3">
						<label class="label" for="name">帳號</label>
						<span class="form-control" name = "account"><?php echo $row['username'] ?></span>
					</div>
					
					<div class="form-group mb-3">
						<label class="label" for="password">修改密碼</label>
						<input type="password" class="form-control" name = "password" placeholder="password" required>
					</div>
					<div class="form-group mb-3">
						<label class="label" for="password">確認修改密碼</label>
						<input type="password" class="form-control" name = "confirm-password" placeholder="confirm-password" required>
					</div>
					<div class="form-group mb-3">
						<label class="label" for="password">Email</label>
						<span  class="form-control" name = "email" ><?php echo $row['useremail'] ?></span>
					</div>
					
					<div class="form-group">
						<button type="submit" class="form-control btn btn-primary submit px-3">修改</button>
					</div>
