<?php
	...
	$sql = "SELECT * FROM `c_order` ORDER BY `c_order`.`date` DESC,`c_order`.`time` DESC";
...
<head>
    <meta charset="utf-8">
    <title>Sweety Administrator order</title>
...
<body>
                ...
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
							...
							<a href="a_order.php" class="nav-item nav-link active">訂單管理</a>  
                        </div>
    ...
    <div class="container-fluid bg-secondary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 300px">
            <h1 class="font-weight-semi-bold text-uppercase mb-3">訂單管理</h1>
